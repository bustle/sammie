...
cli
  ...
  .option('--s3-bucket', 'Name of the S3 bucket where code is uploaded. Defaults to Parameters.bucketName in template')
  .option('--s3-prefix', 'A prefix name added to the packaged code when uploaded to s3')
